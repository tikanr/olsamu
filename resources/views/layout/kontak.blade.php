                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Point akan terus didapatkan apabila kita selalu rajin menukarkan sampah kita melalui
                                                website ini, dan juga dapat ditukarkan melalui menu <a href="/poin">poin</a>.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Untuk pembuatan akun dapat melalui menu registrasi yang telah tersedia
                                                ataupun dapat melalui <a href="/register">tombol berikut</a>.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="col-xl-6 col-lg-6">
                                          <div className="contact-one__left">
                                            <div className="section-title text-left">
                                                <div class="faq-content" style="margin-bottom:30px;">
                                                <h4 class="faq-content-title" style="font-size: 45px; font-weight: bold;"> <center>Jangan ragu untuk kirimkan pertanyaan Anda kepada kami<br></h4></center>
                                            </div>
                                            <form action="mailto:olsam-help@gmail.com" method="post" encType="text/plain" style="text-align: left; font-size:">
                                                <label for="fullname">Nama Lengkap:</label><br>
                                                <input type="text" id="fullname" name="fullname" required><br>
                                                <label for="email">Email address:</label><br>
                                                <input type="email" id="email" name="email" required><br>
                                                <label for="phone">Nomor Ponsel:</label><br>
...
<!-- Mirrored from layerdrops.com/wostin/main-html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 18:08:04 GMT -->
</html>